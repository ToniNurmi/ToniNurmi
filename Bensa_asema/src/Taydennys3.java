		...
		contentPanel.setLayout(null);
		{
			...
			TilaaNappi1.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) 
				{
					try 
					{
						int uusMaara = 1000 - Integer.parseInt(maarad);	//TULOSTAA TIEDOSTOON OIKEAN MÄÄRÄN BENSAA JOS MENEE YLI 1000L
	...
	public static void kirjoitaTiedostoon(String teksti1, String teksti2, String teksti3,String maarat) {
		...
		public void kirjoitaPaivays(String txt, String paivaykset) {
			try 
			{
				...
				fwrite.write(" Tilattu diesel täydennys:" + txt + " litraa" + "\n");
				fwrite.close();
			} catch (Exception e)
			{
				e.printStackTrace();
